...
This module for Testerra framework provides access to videos and vnc streams created by Selenoid Docker container (https://github.com/aerokube/selenoid). Video files are automatically attached to the Testerra report.
